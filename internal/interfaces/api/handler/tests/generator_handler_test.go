...
// MockGeneratorService mocks the GeneratorService interface
...
func TestHandleListTemplates(t *testing.T) {
	...
	mockService := new(MockGeneratorService)
	mockService.On("GetAllTemplates").Return(mockTemplates, nil)
...
func TestHandleListFeatures(t *testing.T) {
	...
	mockService := new(MockGeneratorService)
	mockService.On("GetAvailableFeatures").Return(mockFeatures, nil)
...
func TestHandleGenerateScaffold(t *testing.T) {
	...
	// Setup expectations
	mockService.On("GenerateScaffold", mock.Anything).Run(func(args mock.Arguments) {
		// Verify the options passed to GenerateScaffold
		options := args.Get(0).(model.ScaffoldOptions)
...
func TestHandleDownloadScaffold(t *testing.T) {
	...
	mockService := new(MockGeneratorService)
	mockService.On("GetScaffold", "123").Return(mockScaffold, nil)
